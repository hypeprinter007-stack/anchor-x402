...
description: "Structured decode of any mainnet tx by hash. Supply {chain, tx_hash} for base | ethereum | solana, get back from/to, value, gas, status, calldata (EVM) or slot, fee, signers, program_calls (Solana). Mined txs cached in-process. $0.0005 USDC per call."
...
`POST /v1/decode/tx` — pay $0.0005 USDC, get a normalized decode of any
