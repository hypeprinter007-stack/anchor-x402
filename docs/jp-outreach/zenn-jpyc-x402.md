...
## アップデート（2026-05-25 時点）

公開時から 11 日後の状況：

- **Divigent 統合（2026-05-22）**: エージェントウォレット向けの `assessLiquidity` プリフライト＋アダプティブリザーブ＋ Just-in-time リコール。デモ → https://anchor-x402.com/demos/divigent-x-anchor.mp4
- **日本語カタログ公開（2026-05-25）**: https://anchor-x402.com/llms.ja.txt および `/.well-known/x402.json` の `description_ja` フィールド
- **エンドポイント数 16 種**: 当初 15 → `/v1/roll`（EIP-191 署名付き乱数生成）を追加
- **直近 7 日間で 27 件の有料 POST**（8 エンドポイント・3 レール、すべてオンチェーン検証可能）
- **CDP Bazaar に全 16 エンドポイントがインデックス済み**（payTo: 0x1274…cD0B6）

## ソース

- Repo: https://github.com/hypeprinter007-stack/anchor-x402
- Live API: https://api.anchor-x402.com
- 日本語カタログ: https://anchor-x402.com/llms.ja.txt
- 質問・フィードバック: Twitter [@thexferj](https://x.com/thexferj) または GitHub Issues
